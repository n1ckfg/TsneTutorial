...
# http://pydoc.net/scikit-learn/0.16.1/sklearn.utils.extmath/
_ravel = np.ravel
...
# Now we load the classic handwritten digits datasets. 
...
# It just takes one line with scikit-learn.
